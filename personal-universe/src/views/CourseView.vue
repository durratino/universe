	...
	<section class="course">
		...
		<Banner image="banner">
			...
			<p class="sidenote">Мы хотим узнать наших будущих участников лучше, поэтому вместо прямой оплаты
				предлагаем вам заполнить анкету предзаписи. За&nbsp;заполнение анкеты дарим вам 20-минутную консультацию
				с&nbsp;разбором ваших проблем и&nbsp;запросов в&nbsp;творчестве!</p>
				<p class="sidenote">	Предзапись и&nbsp;консультация не обязывают
				вас приходить на&nbsp;курс, но&nbsp;закрепляют за&nbsp;вами место и&nbsp;стоимость на&nbsp;три&nbsp;дня.
