...
<template>
	<section class="course">
		<Banner image="banner">
			...
			<div class="buttons">
				<a href="https://forms.gle/JEdn86QVGE4yJrww6" target="_blank" class="button button--cta">Записаться на
					курс</a>
		...
		<FlyingText class="is-small">
			<h3>Мастермайнды</h3>
			<p>Онлайн-встречи, где вы будете <strong>изучать путь героя и создание персонажей</strong>. Вы&nbsp;не&nbsp;просто послушаете полезную в&nbsp;создании 
				миров информацию, но&nbsp;и&nbsp;поучаствуете в&nbsp;групповых интерактивах и сразу <strong>попробуете теорию на&nbsp;практике</strong>! Это
			сплотит вас с&nbsp;другими участниками курса, позволит почувствовать свежую творческую волну и&nbsp;вдохновит на&nbsp;собственные идеи.</p>

			<h3>Арт-терапия</h3>
			<p>Онлайн-встречи, на&nbsp;которых вы&nbsp;с&nbsp;помощью арт-терапевта Анастасии Сташкиной <strong>познакомитесь с&nbsp;внутренним
				самозванцем</strong>, чтобы снять оковы
				творческих ограничений и&nbsp;создадите через медитацию и&nbsp;рисунок <strong>безопасное место</strong>, которое может служить вам
				местом
